...
- **Correction Loop:** If the Reviewer rejects the task, you MUST immediately resume the **Coder** persona, fix the issues, and re-submit. **DO NOT EXIT the autonomous loop.**
