...
2. **Draft Content:** Create a new markdown file in `docs/architecture-decisions/` using the template in `~/.gemini/antigravity/skills/architect/resources/ADR-XXX.md`
